...
public class SQLHelper implements Closeable {
     ...
     * <br><br><p><b>EX:</b></p>
     * <p>File liteDB = new File(this.getDataFolder(),"storage.db");</p>
     * <p>SQLHelper.openSQLite(liteDB.toPath());</p>
     *
    ...
    public static Connection openMySQL(String host, int port, String username, String password, String database, boolean useSSL) {
        try {
            ...
            Connection connection = DriverManager.getConnection("jdbc:mysql://" + host + ":" + port, properties);
    ...
    public static Connection openMySQL(String username, String password, String database) {
        return openMySQL("localhost", 3306, username, password, database, false);
    }
